...
async def lifespan(app):
    # Start scheduler som baggrundstask ved serveropstart
    task = _asyncio.create_task(_start_scheduler())
    yield
    task.cancel()
...
async def trigger_digest():
    """Manuel trigger af daglig e-mail digest"""
    from scheduler import run_daily_digest
    _asyncio.create_task(run_daily_digest())
